        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form action="{{route('save-features-item',['id'=>$featuresItem->id])}}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                            ...
                                            >{{$featuresItem->feature_itemTitle}}</textarea>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                            <textarea
                                                ...
                                                aria-describedby="basic-icon-default-message2"
                                                rows="5"
                                            >{{$featuresItem->feature_itemSubtitle}}</textarea>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-3">
                                    <div class="input-group">
                                        <img id="img" src="{{asset($featuresItem->image)}}" alt="" style="height: 100px; width: 100px">
                                    </div>
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="form-check">
                                    <input
                                        ...
                                        value="2"
                                        id="defaultRadio2"
                                        @if($featuresItem->publication_status==2)
                                        checked
                                        @endif
                                    />
