        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form action="{{route('save-event',['id'=>$event->id])}}" method="post">
                            @csrf
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="date" class="form-control" name="date" value="{{$event->date}}" id="basic-default-name" placeholder="Enter Your Blog Public Date" />
                                    @if ($errors->has('date'))
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="time" class="form-control" name="start_time" value="{{$event->start_time}}" id="basic-default-name" placeholder="Enter Your Blog Public Date" />
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="time" class="form-control" name="end_time" value="{{$event->end_time}}" id="basic-default-name" placeholder="Enter Your Blog Public Date" />
                            ...
                            <div class="row justify-content-end">
                                <div class="col-sm-10" >
                                    <button type="submit" class="btn badge-outline-success p-2">Update Event</button>
                                </div>
                            </div>
                        </form>
                    </div>
