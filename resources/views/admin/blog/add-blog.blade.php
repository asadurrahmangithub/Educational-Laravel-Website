...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Page / </span>Add Blog</h4>
                    ...
                    <div class="card-body">
                        <form action="{{route('save-blog')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea
                                        ...
                                        aria-describedby="basic-icon-default-message2"
                                        rows="6"
                                    >{{old('first_description')}}</textarea>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea
                                        ...
                                        aria-describedby="basic-icon-default-message2"
                                        rows="5"
                                    >{{old('middle_description')}}</textarea>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="author" value="{{old('author')}}" id="basic-default-name" placeholder="Enter Your Blog Author Name" />
