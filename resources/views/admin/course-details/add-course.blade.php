            ...
            <div class="col-md-12">
                <div class="card mb-4">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        <h3 class="mb-0">Add Course Section</h3>
                        <a class="text-muted float-end btn badge-outline-primary" href="{{route('manage-course-section')}}">Manage</a>
                    </div>
                    <div class="card-body">
                        <form action="{{route('save-course-section')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea
                                        ...
                                        aria-describedby="basic-icon-default-message2"
                                        rows="9"
                                    >{{old('course_description')}}</textarea>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" class="form-control" name="cost" value="{{old('cost')}}" id="basic-default-name" placeholder="Enter Your Course Total Cost Per Semester" />
                                    @if ($errors->has('cost'))
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" class="form-control" name="total_cost" value="{{old('total_cost')}}" id="basic-default-name" placeholder="Enter Your Course 4 Years(8 semester) Total Cost" />
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" class="form-control" name="semester" value="{{old('semester')}}" id="basic-default-name" placeholder="Enter Your Number of Students" />
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" class="form-control" name="student" value="{{old('student')}}" id="basic-default-name" placeholder="Enter Your Number of Students" />
