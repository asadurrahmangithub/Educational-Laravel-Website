...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Page / </span>Course Header</h4>
            ...
            <div class="col-md-12">
                <div class="card mb-4">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        <h3 class="mb-0">Add Course Header Section</h3>
                    ...
                    <div class="card-body">
                        <form action="{{route('save-section')}}" method="post" >
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="course_header" value="{{$courseHeader->course_header}}" id="basic-default-name" placeholder="Enter Your Course Header Name" />
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea
                                        ...
                                        class="form-control"
                                        placeholder="Enter Your Course Sub Header Name"
